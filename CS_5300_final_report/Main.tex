...
\begin{document}
	\noindent{\textbf{Abstract}}\\
	    ...
	    Learning abilities are enabled by applying Backpropagation algoritm to the Neural Network so it can be trained to get better at the game. The project is implemented in python. 
	    The Neural Network was trained with over 1000 games. Significant improvement could be seen.\\ \\
	...
	2.Neural Network
	The Neural Network is built with 7 layers. The first visiable layer takes a input vector 
	\blindtext\\
...
>>>>>>> 203e23d2f7454c7d83f35b4215dfeb0900556036
